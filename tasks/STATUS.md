...
| Phase 11 — authoritative turn loop               | ✅ **DRAFT COMPLETE** — private durable drafts/locks, persisted resolution recovery, participant projections, independent movie resume/ack, Final Ceremony, canonical replay; 236 tests total                                                                                                         |
...
| Phases 11.5–13 (explainability/ship gate/polish) | 🟨 Phase 11.5 draft-complete; Phase 11.6 in progress (Home-corner selection, automated 3-/4-player lifecycle/restart/replay coverage, and replay-safe resignation landed 2026-07-17; a resign UI control landed 2026-07-18; rooms are never automatically deleted — an earlier idle-cutoff sweep was removed 2026-07-20 after it silently deleted a still-wanted room, and the real four-session/network gate remains for Phase 12); Phase 12 is the v1 production/device ship gate; Phase 13 polishes the core battle game |
| Phases 13.5–16 post-v1 modes                     | ⏸ Phase 13.5 adds online alliances before Phase 14 Stealth and Phase 15 sports; Phase 16 hot-seat/local-device support remains last                                                                                                                                                                   |

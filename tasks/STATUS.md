...
| Phases 11.5–13 (explainability/ship gate/polish) | 🟨 Phase 11.5 draft-complete; Phase 11.6 in progress (Home-corner selection, automated 3-/4-player lifecycle/restart/replay coverage, and replay-safe resignation + abandoned-room sweep landed 2026-07-17; a resign UI control and the real four-session/network gate remain for Phase 12); Phase 12 is the v1 production/device ship gate; Phase 13 polishes the core battle game |

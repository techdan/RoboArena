...
| Phases 11.5–13 (explainability/ship gate/polish) | 🟨 Phase 11.5 draft-complete; Phase 11.6 in progress (Home-corner selection + automated 3-/4-player lifecycle/restart/replay coverage landed 2026-07-17; resignation/abandoned-room and the real four-session/network gate deferred to Phase 12); Phase 12 is the v1 production/device ship gate; Phase 13 polishes the core battle game |

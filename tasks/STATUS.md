...
| Phases 11.5–13 (explainability/ship gate/polish) | 🟨 Phase 11.5 is draft-complete; Phase 11.6 is the 3-/4-player functional gate; Phase 12 is the v1 production/device ship gate; Phase 13 is post-v1 presentation polish                                                                                                                               |
| Phases 14–16 post-v1 modes                       | ⏸ Stealth, non-Survival sports, and hot-seat/alliances are hard-gated on shipped online FFA Survival                                                                                                                                                                                                  |
